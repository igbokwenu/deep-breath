...
const String hollysEmail = "hollywsmith@icloud.com";
const String alansEmail = "job42@att.net";
const String mailIntro = "We look forward to your mail";
const String contactNames = "";
const String hollysWebsite = "https://hollywsmith.com";
const String alansWebsite = "https://bedouinmusings.wordpress.com";
const String hollysContactWebsiteString = "click here to visit Holly's website";
const String alansContactWebsiteString = "click here to visit Alan's website";
